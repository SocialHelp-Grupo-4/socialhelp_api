...
const columns: ColumnDef<TableData>[] = [
    ...
    },
    {
        ...
        header: ({ table }) => h(Checkbox, {
            ...
            "onUpdate:modelValue": (value: boolean | string | undefined) => table.toggleAllPageRowsSelected(!!value),
            "aria-label": "Select all",
        }),
        cell: ({ row }) => h(Checkbox, {
            "modelValue": row.getIsSelected(),
            "onUpdate:modelValue": (value: boolean | string | undefined) => row.toggleSelected(!!value),
